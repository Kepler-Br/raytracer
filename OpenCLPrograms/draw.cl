...
t_ray ray)
{
    ...
    if(intersect(sphere_list, sphere_count,
...
//            printf("%d\n", plane->material_index);
        ...
        set_pixel(x, y, material->absorb_color,
    ...
    //         draw_sphere(*(t_sphere *)sphere_intersection.shape, material_list,
    //                     material_count, x, y, image_array, screen_geometry);
    //     else
    //         draw_plane(*(t_sphere *)plane_intersection.shape, material_list,
    //                     material_count, x, y, image_array, screen_geometry);
    // }
